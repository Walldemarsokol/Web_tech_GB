...
$workexp = [
	[
        ...
        'exp' => 'Lorem ipsum dolor sit amet. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.',
    ],
    [	
    	'startDate' => 'Mar 2012 -',
        'endDate' => 'Dec 2014',
        'job' => 'Web Developer / something.com',
        'exp' => 'Consectetur adipisicing elit. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.',
 	],
    [	
    	'startDate' => 'Jun 2010 -',
        'endDate' => 'Mar 2012',
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b><b><?php echo $workexp[$i]['job'] ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
          <?php echo $workexp[$i]['startDate'] ?>
          <?php if($i ==0):?>
          <span class="w3-tag w3-teal w3-round"><?php echo $workexp[$i]['endDate'] ?>
          </span>
          <?php else:?>
          <?php echo $workexp[$i]['endDate'] ?>
          <?php endif;?>
          </h6>
          <p><?php echo $workexp[$i]['exp'] ?></p>
          <hr>
        </div>
        <?php endfor;?>
      </div>
